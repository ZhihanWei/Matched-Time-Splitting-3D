...
double Beta_4::Inside(Doub_I x, Doub_I y, Doub_I z) const {
  ...
  temp = exp((x * x / (2 * in_sigma_x * in_sigma_x) +
              y * y / (2 * in_sigma_y * in_sigma_y) +
              z * z / (2 * in_sigma_z * in_sigma_z)));
...
double Beta_4::Outside(Doub_I x, Doub_I y, Doub_I z) const {
  ...
  temp = exp((x * x / (2 * out_sigma_x * out_sigma_x) +
              y * y / (2 * out_sigma_y * out_sigma_y) +
              z * z / (2 * out_sigma_z * out_sigma_z)));
...
double Beta_4::Inside_Dx(Doub_I x, Doub_I y, Doub_I z) const {
  ...
  temp = (x / in_sigma_x / in_sigma_x) *
         exp((x * x / (2 * in_sigma_x * in_sigma_x) +
              y * y / (2 * in_sigma_y * in_sigma_y) +
              z * z / (2 * in_sigma_z * in_sigma_z)));
...
double Beta_4::Outside_Dx(Doub_I x, Doub_I y, Doub_I z) const {
  ...
  temp = (x / out_sigma_x / out_sigma_x) *
         exp((x * x / (2 * out_sigma_x * out_sigma_x) +
              y * y / (2 * out_sigma_y * out_sigma_y) +
              z * z / (2 * out_sigma_z * out_sigma_z)));
...
double Beta_4::Outside_Dy(Doub_I x, Doub_I y, Doub_I z) const {
  ...
  temp = (y / out_sigma_y / out_sigma_y) *
         exp((x * x / (2 * out_sigma_x * out_sigma_x) +
              y * y / (2 * out_sigma_y * out_sigma_y) +
              z * z / (2 * out_sigma_z * out_sigma_z)));
...
double Beta_4::Outside_Dz(Doub_I x, Doub_I y, Doub_I z) const {
  ...
  temp = (z / out_sigma_z / out_sigma_z) *
         exp((x * x / (2 * out_sigma_x * out_sigma_x) +
              y * y / (2 * out_sigma_y * out_sigma_y) +
              z * z / (2 * out_sigma_z * out_sigma_z)));
