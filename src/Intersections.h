...
private:
    ...
    void Setup_Intersections(Surface_Cartesian&, ofstream&);
    void Getdata_irr_z(Int_I, Int_I, Int_I, Surface_Cartesian&, Intersection_Data&);
    void Getdata_irr_x(Int_I, Int_I, Int_I, Surface_Cartesian&, Intersection_Data&);
    void Getdata_irr_y(Int_I, Int_I, Int_I, Surface_Cartesian&, Intersection_Data&);
    void Getdata_cor_z(Int_I, Int_I, Int_I, Surface_Cartesian&, Intersection_Data&, Intersection_Data&);
    void Getdata_cor_x(Int_I, Int_I, Int_I, Surface_Cartesian&, Intersection_Data&, Intersection_Data&);
    void Getdata_cor_y(Int_I, Int_I, Int_I, Surface_Cartesian&, Intersection_Data&, Intersection_Data&);
  
    void Irregular_MIB(Intersection_Data&, Doub_I);
    void Irregular_MIB_Recursive(Intersection_Data&, Doub_I, Int_I, Int_I, VecDoub_O&);
    void Irregular_MIB_2nd(Intersection_Data&, Doub_I, Int_I);
    void Get_irr_weights(Doub_I, Doub_I, Int_I, MatrixDoub_O&, MatrixDoub_O&);
    void Corner_MIB_2nd(Intersection_Data&, Intersection_Data&, Doub_I);
    ...
    double Eta_x(Intersection_Data&, CubicDoub&, Equation&);
    double Tau_x(Intersection_Data&, CubicDoub&, Equation&);
    double Eta_y(Intersection_Data&, CubicDoub&);
    double Tau_y(Intersection_Data&, CubicDoub&);
    double Eta_z(Intersection_Data&, CubicDoub&);
    double Tau_z(Intersection_Data&, CubicDoub&);
    
    double Eta_Plus(Doub_I, Doub_I);
    double Eta_Minus(Doub_I, Doub_I);
    double Tau_Plus(Doub_I, Doub_I);
    double Tau_Minus(Doub_I, Doub_I);
...
public:
    ...
    void Refresh_Jump(Equation&, CubicDoub&);
