...
/******************************************************************************************
 ...
 and time step accuracy : accuracy of scheme
 *******************************************************************************************/
...
/*********************************************************************************
 ...
 uc2   : right hand side solution at current time step
 ********************************************************************************/
void LOD::D_xx_r_cn(Equation &eq, Intersections &inter, CubicDoub &uc1,
...
/*********************************************************************************
 ...
 uc2   : right hand side solution at current time step
 ********************************************************************************/
void LOD::D_yy_r_cn(Equation &eq, Intersections &inter, CubicDoub &uc1,
                    CubicDoub &uc2, Beta &beta) {
  int iy;
  size_t ip;
  double coef, sum;
...
/*********************************************************************************
 ...
 uc2   : right hand side solution at current time step
 ********************************************************************************/
void LOD::D_zz_r_cn(Equation &eq, Intersections &inter, CubicDoub &uc1,
                    CubicDoub &uc2, Beta &beta) {
  int iz;
  size_t ip;
  double coef, sum;
 ...
 **********************************************************************************************************/
void LOD::Operator_weights_x(Beta &beta, VecDoub_O &vdex, Int_I ix, Int_I iy,
                             Int_I iz, Doub_I dx) {
  int indx;
  double beta1, beta2;
 ...
 **********************************************************************************************************/
void LOD::Operator_weights_y(Beta &beta, VecDoub_O &vdey, Int_I ix, Int_I iy,
                             Int_I iz, Doub_I dy) {
  int indx;
  double beta1, beta2;
 ...
 **********************************************************************************************************/
void LOD::Operator_weights_z(Beta &beta, VecDoub_O &vdez, Int_I ix, Int_I iy,
                             Int_I iz, Doub_I dz) {
  int indx;
  double beta1, beta2;
...
/**********************************************************************************************************
 ...
 r   : right hand side vector
 **********************************************************************************************************/
void LOD::Convert2Tri_irr(Int_I ix, MatrixDoub_I &row, VecDoub_O &a,
...
/**********************************************************************************************************
 ...
 r   : right hand side vector
 **********************************************************************************************************/
void LOD::Convert2Tri_cor(Int_I ix, MatrixDoub_I &row, VecDoub_O &a,
                          VecDoub_O &b, VecDoub_O &c, VecDoub_O &r) {
  double rate[3];
 ...
 *********************************************************************/
void LOD::TDMA(VecDoub_I &a, VecDoub_I &b, VecDoub_I &c, VecDoub_I &r,
               VecDoub_O &u) {
  int n = (int)a.size();
  double bet;
