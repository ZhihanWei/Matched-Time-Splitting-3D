...
double Surface_Pile::Set_Node(Doub_I x, Doub_I y, Doub_I z) const
{
    ...
    diff = 5*pow((x*x+y*y+5*z*z-10),3) + 5*pow((x*x+60*y*y+3*z*z-2),2) + TOL_SETUP;
...
/*********************************************************************************
 ...
 value of function
 **********************************************************************************/
double Surface_Pile::func(const Doub_I x, const Doub_I y, const Doub_I z) const
{
    double temp;
    
    temp = 5*pow((x*x+y*y+5*z*z-10),3) + 5*pow((x*x+60*y*y+3*z*z-2),2);
...
double Surface_Pile::dfx(const Doub_I x, const Doub_I y, const Doub_I z) const
{
    ...
    temp = 30*x*pow((x*x+y*y+5*z*z-10),2) - 20*x*(x*x+60*y*y+3*z*z-2);
...
double Surface_Pile::dfy(const Doub_I x, const Doub_I y, const Doub_I z) const
{
    ...
    temp = 30*y*pow((x*x+y*y+5*z*z-10),2) - 1200*y*(x*x+60*y*y+3*z*z-2);
...
double Surface_Pile::dfz(const Doub_I x, const Doub_I y, const Doub_I z) const
{
    ...
    temp = 150*z*pow((x*x+y*y+5*z*z-10),2) - 60*z*(x*x+60*y*y+3*z*z-2);
...
VecDoub Surface_Pile::normal(Doub_I x, Doub_I y, Doub_I z)
{
    ...
    total = sqrt(pow(30*x*pow((x*x+y*y+5*z*z-10),2)-20*x*(x*x+60*y*y+3*z*z-2),2)+
                 pow(30*y*pow((x*x+y*y+5*z*z-10),2)-1200*y*(x*x+60*y*y+3*z*z-2),2)+
                 pow(150*z*pow((x*x+y*y+5*z*z-10),2)-60*z*(x*x+60*y*y+3*z*z-2),2));
    
    temp = (30*x*pow((x*x+y*y+5*z*z-10),2)-20*x*(x*x+60*y*y+3*z*z-2))/total;
    normal.push_back(temp);
    temp = (30*y*pow((x*x+y*y+5*z*z-10),2)-1200*y*(x*x+60*y*y+3*z*z-2))/total;
    normal.push_back(temp);
    temp = (150*z*pow((x*x+y*y+5*z*z-10),2)-60*z*(x*x+60*y*y+3*z*z-2))/total;
    normal.push_back(temp);
