...
double Surface_Ellipsoid::Set_Node(Doub_I x, Doub_I y, Doub_I z) const
{
    ...
    diff = x*x/(a*a) + y*y/(b*b) + z*z/(c*c) - radius*radius + TOL_SETUP;
...
/*********************************************************************************
 ...
 value of function
 **********************************************************************************/
double Surface_Ellipsoid::func(const Doub_I x, const Doub_I y, const Doub_I z) const
{
    double temp;
 ...
 ***********************************************************************/
double Surface_Ellipsoid::dfx(const Doub_I x, const Doub_I y, const Doub_I z) const
{
    double temp;
 ...
 ***********************************************************************/
double Surface_Ellipsoid::dfy(const Doub_I x, const Doub_I y, const Doub_I z) const
{
    double temp;
 ...
 ***********************************************************************/
double Surface_Ellipsoid::dfz(const Doub_I x, const Doub_I y, const Doub_I z) const
{
    double temp;
...
VecDoub Surface_Ellipsoid::normal(Doub_I x, Doub_I y, Doub_I z)
{
    ...
    total = sqrt(pow(2*x/(a*a),2)+pow(2*y/(b*b),2)+pow(2*z/(c*c),2));
...
void Surface_Ellipsoid::display()
{
    ...
    cout << "f(x) = 1/" << a*a << "*x^2+" << "1/" << b*b <<"*y^2+" << "1/" << c*c << "*z^2-(" << radius << ")^2 = 0" << endl;
}
