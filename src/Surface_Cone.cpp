...
/*********************************************************************************
 ...
 value of function
 **********************************************************************************/
double Surface_Cone::func(const Doub_I x, const Doub_I y,
...
VecDoub Surface_Cone::normal(Doub_I x, Doub_I y, Doub_I z) {
  ...
  if (z == z_lower) {
    ...
    total = sqrt(pow(2 * x / (a * a), 2) + pow(2 * y / (a * a), 2) +
                 pow(-2 * (z - b), 2));
...
void Surface_Cone::display() {
  ...
  cout << "f(x) = (x^2 + y^2)/" << a * a << " - (z- " << b << "^2)- " << c
       << " = 0, where z in [" << z_lower << "," << z_upper << "]" << endl;
}
