...
private:
  ...
  void Irregular_MIB_L2_Recursive(Intersection_Data &, Beta &, Doub_I, Int_I,
                                  Int_I, VecDoub_O &);
  void Irregular_MIB_L2_2nd(Intersection_Data &, Doub_I, Int_I);
  void Corner_MIB_L2_2nd(Intersection_Data &, Intersection_Data &, Beta &,
                         Doub_I);
  void Get_irr_weights(Doub_I, Doub_I, Int_I, MatrixDoub_O &, MatrixDoub_O &);
  void Get_cor_weights(Doub_I, Doub_I, Doub_I, MatrixDoub_O &, MatrixDoub_O &,
                       MatrixDoub_O &, MatrixDoub_O &);
  //----------------- MIB-L2 related ----------------------
