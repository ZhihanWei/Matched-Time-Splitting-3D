...
/**************************************************************************************************************
 ...
 mesh        : mesh object (at least contains: nx, dx, grids location xi[n] and
 grid indicator mesh_value[i]) beta        : variable coefficients object
...
Intersections::Intersections(Surface_Cartesian &ex, Mesh &mesh, Beta &beta,
  ...
  if (mib_method == 1) {
    ...
    cout << "No method for MIB part is found (1: L1 method & 2: L2 method)"
         << endl;
    exit(0);
  }
}
...
void Intersections::Setup_Intersections(Surface_Cartesian &ex, Beta &beta,
  ...
  for (int ix = 1; ix < nx - 1; ix++) {
    ...
    for (int iy = 1; iy < ny - 1; iy++) {
        ...
        if (indicator[indx] * indicator[indx1] < 0) {
          ...
          // Corner interface point
            ...
            if (indicator[indx2] * indicator[indx3] < 0) {
              cout << "Two corner interfaces coherent in Z-direction at "
                   << "IX: " << ix << " IY: " << iy << endl;
              exit(0);
            } else {
              out_file << "Corner interface is found in Z-direction at "
                       << "IX: " << ix << " IY: " << iy << endl;
              ...
              Getdata_cor_z(ix, iy, iz, ex, inter_node_left, inter_node_right,
                            beta);
      ...
      if (ifp % 2 == 1) {
        cout << "It's an open surface in Z-direction, change the size of domain"
             << endl;
        exit(0);
      }
    }
  ...
  for (int ix = 1; ix < nx - 1; ix++) {
    ...
    for (int iz = 1; iz < nz - 1; iz++) {
      ...
      while (iy < ny - 1) {
        ...
        if (indicator[indx] * indicator[indx1] < 0) {
          ...
          // Corner interface point
            ...
            if (indicator[indx2] * indicator[indx3] < 0) {
              cout << "Two corner interfaces coherent in Y-direction at "
                   << "IX: " << ix << " IZ: " << iz << endl;
              exit(0);
            } else {
              out_file << "Corner interface is found in Y-direction at "
                       << "IX: " << ix << " IZ: " << iz << endl;
              ...
              Getdata_cor_y(ix, iy, iz, ex, inter_node_left, inter_node_right,
                            beta);
      ...
      if (ifp % 2 == 1) {
        cout << "It's an open surface in Y-direction, change the size of domain"
             << endl;
        exit(0);
      }
    }
  ...
  for (int iy = 1; iy < ny - 1; iy++) {
    ...
    for (int iz = 1; iz < nz - 1; iz++) {
      ...
      while (ix < nx - 1) {
        ...
        if (indicator[indx] * indicator[indx1] < 0) {
          ...
          // Corner interface point
            ...
            if (indicator[indx2] * indicator[indx3] < 0) {
              cout << "Two corner interfaces coherent in X-direction at "
                   << "IY: " << iy << " IZ: " << iz << endl;
              exit(0);
            } else {
              out_file << "Corner interface is found in X-direction at "
                       << "IY: " << iy << " IZ: " << iz << endl;
              ...
              ifp += 1;
              inter_node_right.ID = -ifp;
              Getdata_cor_x(ix, iy, iz, ex, inter_node_left, inter_node_right,
                            beta);
      ...
      if (ifp % 2 == 1) {
        cout << "It's an open surface in X-direction, change the size of domain"
             << endl;
        exit(0);
      }
    }
 ...
 *************************************************************************************************/
void Intersections::Getdata_irr_z(Int_I ix, Int_I iy, Int_I iz,
                                  Surface_Cartesian &ex,
                                  Intersection_Data &inter_node, Beta &beta) {
  inter_node.dir = 'z';
...
/*************************************************************************************************
 ...
 inter_node : intersection node need to be initialized
 *************************************************************************************************/
void Intersections::Getdata_irr_y(Int_I ix, Int_I iy, Int_I iz,
                                  Surface_Cartesian &ex,
                                  Intersection_Data &inter_node, Beta &beta) {
  inter_node.dir = 'y';
...
/*************************************************************************************************
 ...
 inter_node : intersection node need to be initialized
 *************************************************************************************************/
void Intersections::Getdata_irr_x(Int_I ix, Int_I iy, Int_I iz,
                                  Surface_Cartesian &ex,
                                  Intersection_Data &inter_node, Beta &beta) {
  inter_node.dir = 'x';
 ...
 *************************************************************************************************/
void Intersections::Getdata_cor_z(Int_I ix, Int_I iy, Int_I iz,
                                  Surface_Cartesian &ex,
                                  Intersection_Data &inter_node_left,
                                  Intersection_Data &inter_node_right,
                                  Beta &beta) {
  ...
  inter_node_left.coord.z_value =
      ex.Gamma_z(xi[ix], yi[iy], zi[iz], zi[iz + 1]);
  ...
  inter_node_left.diffcoef.inside =
      beta.Inside(inter_node_left.coord.x_value, inter_node_left.coord.y_value,
                  inter_node_left.coord.z_value);
  inter_node_left.diffcoef.outside =
      beta.Outside(inter_node_left.coord.x_value, inter_node_left.coord.y_value,
                   inter_node_left.coord.z_value);

  inter_node_left.local.normal =
      ex.normal(inter_node_left.coord.x_value, inter_node_left.coord.y_value,
                inter_node_left.coord.z_value);
  ...
  inter_node_right.coord.z_value =
      ex.Gamma_z(xi[ix], yi[iy], zi[iz + 1], zi[iz + 2]);
  ...
  inter_node_right.diffcoef.inside = beta.Inside(
      inter_node_right.coord.x_value, inter_node_right.coord.y_value,
      inter_node_right.coord.z_value);
  inter_node_right.diffcoef.outside = beta.Outside(
      inter_node_right.coord.x_value, inter_node_right.coord.y_value,
      inter_node_right.coord.z_value);

  inter_node_right.local.normal =
      ex.normal(inter_node_right.coord.x_value, inter_node_right.coord.y_value,
                inter_node_right.coord.z_value);
...
/*************************************************************************************************
 ...
 inter_node_right : right intersection node need to be initialized
 *************************************************************************************************/
void Intersections::Getdata_cor_y(Int_I ix, Int_I iy, Int_I iz,
                                  Surface_Cartesian &ex,
                                  Intersection_Data &inter_node_left,
                                  Intersection_Data &inter_node_right,
                                  Beta &beta) {
  ...
  inter_node_left.coord.x_value = xi[ix];
  inter_node_left.coord.y_value =
      ex.Gamma_y(xi[ix], yi[iy], yi[iy + 1], zi[iz]);
  ...
  inter_node_right.coord.x_value = xi[ix];
  inter_node_right.coord.y_value =
      ex.Gamma_y(xi[ix], yi[iy + 1], yi[iy + 2], zi[iz]);
...
/*************************************************************************************************
 ...
 inter_node_right : right intersection node need to be initialized
 *************************************************************************************************/
void Intersections::Getdata_cor_x(Int_I ix, Int_I iy, Int_I iz,
                                  Surface_Cartesian &ex,
                                  Intersection_Data &inter_node_left,
                                  Intersection_Data &inter_node_right,
                                  Beta &beta) {
  ...
  inter_node_left.coord.x_value =
      ex.Gamma_x(xi[ix], xi[ix + 1], yi[iy], zi[iz]);
  inter_node_left.coord.y_value = yi[iy];
  inter_node_left.coord.z_value = zi[iz];
  ...
  inter_node_right.coord.x_value =
      ex.Gamma_x(xi[ix + 1], xi[ix + 2], yi[iy], zi[iz]);
  inter_node_right.coord.y_value = yi[iy];
  inter_node_right.coord.z_value = zi[iz];
...
void Intersections::MIB_L1(Intersection_Data &inter_node, Beta &beta, Doub_I dv,
  ...
  if (abs(inter_node.ID) % 2 == 0) //"-" => "+", BETA^{-}U_{X}^{-} =
                                   // BETA^{+}U_{X}^{+} - [BETA U_{X}], F = G -
                                   //[BETA U_{X}]
  {
    coefr = inter_node.diffcoef.inside;
    coefl = inter_node.diffcoef.outside;
  } else //"+" => "-", BETA^{-}U_{X}^{-} = BETA^{+}U_{X}^{+} - [BETA U_{X}], G
         //+ [BETA U_{X}] = F
  {
  ...
  for (int i = 0; i < onefp_unknowns; i++) {
    ...
    A[onefp_unknowns + i][onefp_unknowns + i] =
        wei[order][1] * coefr; // Right FP
  }
  ...
  if (abs(lu_dcmp.det()) < TOL_SETUP) {
    cout << "Warning: when solving IRREGULAR interface, A is a singular matrix "
            "locate at: X = "
    ...
    for (int i = 0; i < total_unknowns; i++) {
      ...
      if (abs(B[i] - sum) > TOL_SETUP) {
        cout << "B[" << i << "] approximation error: " << abs(B[i] - sum)
             << endl;
      }
    }
    cout << endl;
...
/******************************************************************************
 ...
 dv               : grid mesh size
 ******************************************************************************/
void Intersections::Irregular_MIB_L1(Intersection_Data &inter_node, Beta &beta,
                                     Doub_I dv) {
  VecDoub x;
  int onefp_unknowns;
...
void Intersections::Irregular_MIB_L2(Intersection_Data &inter_node, Beta &beta,
  ...
  onefp_unknowns =
      accuracy * 2 + 2;    // numbers of unknowns for one fictitious points
  stlength = accuracy + 1; // length of FD stencil
  fpno = accuracy / 2;     // numbers of fictitious points on oneside at current
                           // intersection given accuracy
  ...
  for (int i = 0; i < fpno; i++) {
    ...
    Irregular_MIB_L2_Recursive(inter_node, beta, dv, onefp_unknowns, stlength,
                               x);
...
/***************************************************************************************
 ...
 x : vector of weights for a pair of fictitious points
 ****************************************************************************************/
void Intersections::Irregular_MIB_L2_Recursive(Intersection_Data &inter_node,
                                               Beta &beta, Doub_I dv,
                                               Int_I onefp_unknowns,
                                               Int_I stlength, VecDoub_O &x) {
  ...
  for (int i = 0; i < stlength - oneside_pts - 1; i++) {
    for (int j = 0; j < onefp_unknowns; j++) {
      ...
      B[j] += weil[order][stlength - oneside_pts - 1 - i] *
              inter_node.wei.weil[i][j];
    }
  }
  ...
  for (int i = 0; i < oneside_pts; i++) {
    ...
    B[onefp_unknowns + oneside_pts + i] +=
        weil[order][stlength - oneside_pts + i] * coefl; // Left FP
  }
  // All calculated fictitious points weight
  for (int i = 0; i < stlength - oneside_pts - 1; i++) {
    for (int j = 0; j < onefp_unknowns; j++) {
      B[onefp_unknowns + j] += -weir[order][oneside_pts + i] * coefr *
                               inter_node.wei.weir[i][j]; // Right FP
      B[onefp_unknowns + j] += weil[order][stlength - oneside_pts - 1 - i] *
                               coefl * inter_node.wei.weil[i][j]; // Left FP
    }
  }
  // Two fictitious points weight
  for (int i = 0; i < onefp_unknowns; i++) {
    A[onefp_unknowns + i][onefp_unknowns + i] =
        weir[order][stlength - 1] * coefr;              // Right FP
...
/***************************************************************************************************************
 ...
 INPUT
 gamma        : distance between intersection node with its left neighbor grid
 point dv           : grid mesh size oneside_pts  : number of nodes on oneside
 ...
 *    : REAL POINTS
 ...
 -----------*---------------*--------x-------*---------------*-------------
 ---------------------------O--------x-------*---------------*-------------
 LEFT FP INTERPOLATION
 -----------*---------------*--------x-------O-----------------------------
 RIGHT FP INTERPOLATION
 *****************************************************************************************************************/
void Intersections::Get_irr_weights(Doub_I gamma, Doub_I dv, Int_I oneside_pts,
                                    MatrixDoub_O &weil, MatrixDoub_O &weir) {
  VecDoub vl, vr;
  MatrixDoub temp;
  int ns, order;
...
void Intersections::Corner_MIB_L2_2nd(Intersection_Data &inter_node_left,
  ...
  int order;
  int oneside_unknowns, total_unknowns, dev_order, stlength;

  oneside_unknowns = 5 + 2 * 2; // numbers of unknowns for one fictitious
                                // points
  ...
  for (int i = 0; i < oneside_unknowns; i++) {
    ...
    A[i][oneside_unknowns * 3 + i] =
        -left_wei_in[order][3]; // 4th FP, at ix-1 or ix+3
  }
  ...
  for (int i = 0; i < oneside_unknowns; i++) {
    A[oneside_unknowns + i][i] =
        -left_wei_in[order][0] * coef_in; // 1st FP, at ix
    A[oneside_unknowns + i][oneside_unknowns + i] =
        left_wei_out[order][2] * coef_out; // 2nd FP, at ix+1
    A[oneside_unknowns + i][oneside_unknowns * 2 + i] =
        -left_wei_in[order][2] * coef_in; // 3rd FP, at ix+2
    // 4th FP, at ix-1 or ix+3
    if ((dv - inter_node_left.gamma) >
        inter_node_right.gamma) // 4th FP, at ix-1
    {
      A[oneside_unknowns + i][oneside_unknowns * 3 + i] =
          -left_wei_in[order][3] * coef_in;
    } else // 4th FP, at ix+3
    {
      A[oneside_unknowns + i][oneside_unknowns * 3 + i] =
          -left_wei_in[order][3] * coef_in;
  ...
  for (int i = 0; i < oneside_unknowns; i++) {
    ...
    A[oneside_unknowns * 2 + i][oneside_unknowns + i] =
        right_wei_out[order][1]; // 2nd FP, at ix+1
    A[oneside_unknowns * 2 + i][oneside_unknowns * 2 + i] =
        -right_wei_in[order][2]; // 3rd FP, at ix+2
    A[oneside_unknowns * 2 + i][oneside_unknowns * 3 + i] =
        -right_wei_in[order][3]; // 4th FP, at ix-1 or ix+3
  }
  if (abs(inter_node_left.ID) % 2 == 0) //"-" => "+" => "-"
  {
  ...
  B[oneside_unknowns * 3 + 1] = -right_wei_out[order][0] * coef_out; // GP at
                                                                     // ix
  B[oneside_unknowns * 3 + 2] = right_wei_in[order][1] * coef_in; // GP at ix+1
  B[oneside_unknowns * 3 + 3] =
      -right_wei_out[order][2] * coef_out; // GP at ix+2
  B[oneside_unknowns * 3 + 4] =
      -right_wei_out[order][3] * coef_out; // GP at ix+3
  for (int i = 0; i < oneside_unknowns; i++) {
    A[oneside_unknowns * 3 + i][i] =
        -right_wei_in[order][0] * coef_in; // 1st FP, at ix
    A[oneside_unknowns * 3 + i][oneside_unknowns + i] =
        right_wei_out[order][1] * coef_out; // 2nd FP, at ix+1
    A[oneside_unknowns * 3 + i][oneside_unknowns * 2 + i] =
        -right_wei_in[order][2] * coef_in; // 3rd FP, at ix+2
    // 4th FP, at ix-1 or ix+3
    if ((dv - inter_node_left.gamma) >
        inter_node_right.gamma) // 4th FP, at ix-1
    {
      A[oneside_unknowns * 3 + i][oneside_unknowns * 3 + i] =
          -right_wei_in[order][3] * coef_in;
    } else // 4th FP, at ix+3
    {
      A[oneside_unknowns * 3 + i][oneside_unknowns * 3 + i] =
          -right_wei_in[order][3] * coef_in;
  ...
  if (abs(lu_dcmp.det()) < TOL_SETUP) {
    cout << "Warning: when solving CORNER interface, A is a singular matrix "
            "locate at: X = "
         << inter_node_left.coord.x_value
         << " Y = " << inter_node_left.coord.y_value
...
/**********************************************************************************************************************
 ...
 INPUT
 gamma_left  : distance between left intersection node with its left neighbor
 grid point
 gamma_right : distance between right intersection node with its left neighbor
 grid point
 dv          : grid mesh size
 ...
 *    : REAL POINTS
 ...
 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  CORNER LEFT INTERFACE
 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~     (itype_left,itype_right)
 ---------*---------------*-------x--------*--------x-------*---------------*----------
 ...
 (  0 , 2 )
 ********************************************************************************************************************/
void Intersections::Get_cor_weights(Doub_I gamma_left, Doub_I gamma_right,
                                    Doub_I dv, MatrixDoub_O &left_wei_out,
                                    MatrixDoub_O &left_wei_in,
                                    MatrixDoub_O &right_wei_out,
                                    MatrixDoub_O &right_wei_in) {
  VecDoub left_v_out, left_v_in, right_v_out, right_v_in;
  MatrixDoub temp;
  int ns, order;

  ns = (int)left_wei_out[0].size();
  if ((int)left_wei_in[0].size() != ns || (int)right_wei_out[0].size() != ns ||
      (int)right_wei_in[0].size() != ns) {
    cout << "Different size for input matrix when getting weights" << endl;
    exit(0);
  }

  order = (int)left_wei_out.size();
  if ((int)left_wei_in.size() != order || (int)right_wei_out.size() != order ||
      (int)right_wei_in.size() != order) {
    cout << "Different size for input matrix when getting weights" << endl;
    exit(0);
  }
  ...
  if ((dv - gamma_left) > gamma_right) {
    left_v_in[ns - 1] =
        -dv; //(-2,0), center point close to right interface, 4th FP changes
  }
      ...
      while (ip < ifpz[ix][iy].size()) {
        if (ifpz[ix][iy][ip].ID > 0) {
          ...
          for (int i = 0; i < fpno; i++) {
            ...
            for (int j = 0; j < n; j++) {
              suml += inter_node.wei.weil[i][j] *
                      u[ix][iy][iz - oneside_pts + 1 + j];
              sumr += inter_node.wei.weir[i][j] *
                      u[ix][iy][iz - oneside_pts + 1 + j];
            }

            ifpz[ix][iy][ip].err.errl[i] =
                abs((invu[ix][iy][iz - i] - suml) / invu[ix][iy][iz - i]);
            ifpz[ix][iy][ip].err.errr[i] = abs(
                (invu[ix][iy][iz + 1 + i] - sumr) / invu[ix][iy][iz + 1 + i]);
          }
        ...
        } else // Corner interface
        {
          ...
          if (n == (int)inter_node_left.wei.weir[0].size() &&
              n == (int)inter_node_right.wei.weil[0].size() &&
              n == (int)inter_node_right.wei.weir[0].size()) {
            n = n - 2 * 2;
          } else {
          ...
          left_suml += inter_node_left.wei.weil[0][n] *
                       eq.Jump_u(left_x, left_y, left_z);
          left_suml += inter_node_left.wei.weil[0][n + 1] *
                       eq.Jump_betau_z(left_x, left_y, left_z);
          left_suml += inter_node_left.wei.weil[0][n + 2] *
                       eq.Jump_u(right_x, right_y, right_z);
          left_suml += inter_node_left.wei.weil[0][n + 3] *
                       eq.Jump_betau_z(right_x, right_y, right_z);

          left_sumr += inter_node_left.wei.weir[0][n] *
                       eq.Jump_u(left_x, left_y, left_z);
          left_sumr += inter_node_left.wei.weir[0][n + 1] *
                       eq.Jump_betau_z(left_x, left_y, left_z);
          left_sumr += inter_node_left.wei.weir[0][n + 2] *
                       eq.Jump_u(right_x, right_y, right_z);
          left_sumr += inter_node_left.wei.weir[0][n + 3] *
                       eq.Jump_betau_z(right_x, right_y, right_z);

          right_sumr += inter_node_right.wei.weir[0][n] *
                        eq.Jump_u(left_x, left_y, left_z);
          right_sumr += inter_node_right.wei.weir[0][n + 1] *
                        eq.Jump_betau_z(left_x, left_y, left_z);
          right_sumr += inter_node_right.wei.weir[0][n + 2] *
                        eq.Jump_u(right_x, right_y, right_z);
          right_sumr += inter_node_right.wei.weir[0][n + 3] *
                        eq.Jump_betau_z(right_x, right_y, right_z);
          ...
          for (int i = 0; i < n; i++) {
            ...
            right_sumr +=
                inter_node_right.wei.weir[0][i] * u[ix][iy][iz - 1 + i];
          }

          // Left corner interface
          ifpz[ix][iy][ip].err.errl[0] =
              abs((invu[ix][iy][iz] - left_suml) / invu[ix][iy][iz]);
          ifpz[ix][iy][ip].err.errr[0] =
              abs((invu[ix][iy][iz + 1] - left_sumr) / invu[ix][iy][iz + 1]);

          // Right corner interface
          ifpz[ix][iy][ip + 1].err.errl[0] = ifpz[ix][iy][ip].err.errr[0];
          ifpz[ix][iy][ip + 1].err.errr[0] =
              abs((invu[ix][iy][iz + 2] - right_sumr) / invu[ix][iy][iz + 2]);
      ...
      while (ip < ifpy[ix][iz].size()) {
        if (ifpy[ix][iz][ip].ID > 0) {
          ...
          for (int i = 0; i < fpno; i++) {
            ...
            for (int j = 0; j < n; j++) {
              suml += inter_node.wei.weil[i][j] *
                      u[ix][iy - oneside_pts + 1 + j][iz];
              sumr += inter_node.wei.weir[i][j] *
                      u[ix][iy - oneside_pts + 1 + j][iz];
              ;
            }

            ifpy[ix][iz][ip].err.errl[i] =
                abs((invu[ix][iy - i][iz] - suml) / invu[ix][iy - i][iz]);
            ifpy[ix][iz][ip].err.errr[i] = abs(
                (invu[ix][iy + 1 + i][iz] - sumr) / invu[ix][iy + 1 + i][iz]);
          }
        ...
        } else // Corner interface
        {
          ...
          left_suml += inter_node_left.wei.weil[0][n] *
                       eq.Jump_u(left_x, left_y, left_z);
          left_suml += inter_node_left.wei.weil[0][n + 1] *
                       eq.Jump_betau_y(left_x, left_y, left_z);
          left_suml += inter_node_left.wei.weil[0][n + 2] *
                       eq.Jump_u(right_x, right_y, right_z);
          left_suml += inter_node_left.wei.weil[0][n + 3] *
                       eq.Jump_betau_y(right_x, right_y, right_z);
          ...
          for (int i = 0; i < n; i++) {
            ...
            right_sumr +=
                inter_node_right.wei.weir[0][i] * u[ix][iy - 1 + i][iz];
          }

          // Left corner interface
          ifpy[ix][iz][ip].err.errl[0] =
              abs((invu[ix][iy][iz] - left_suml) / invu[ix][iy][iz]);
          ifpy[ix][iz][ip].err.errr[0] =
              abs((invu[ix][iy + 1][iz] - left_sumr) / invu[ix][iy + 1][iz]);

          // Right corner interface
          ifpy[ix][iz][ip + 1].err.errl[0] = ifpy[ix][iz][ip].err.errr[0];
          ifpy[ix][iz][ip + 1].err.errr[0] =
              abs((invu[ix][iy + 2][iz] - right_sumr) / invu[ix][iy + 2][iz]);
      ...
      while (ip < ifpx[iy][iz].size()) {
        if (ifpx[iy][iz][ip].ID > 0) {
          ...
          for (int i = 0; i < fpno; i++) {
            ...
            for (int j = 0; j < n; j++) {
              suml += inter_node.wei.weil[i][j] *
                      u[ix - oneside_pts + 1 + j][iy][iz];
              sumr += inter_node.wei.weir[i][j] *
                      u[ix - oneside_pts + 1 + j][iy][iz];
            }

            ifpx[iy][iz][ip].err.errl[i] =
                abs((invu[ix - i][iy][iz] - suml) / invu[ix - i][iy][iz]);
            ifpx[iy][iz][ip].err.errr[i] = abs(
                (invu[ix + 1 + i][iy][iz] - sumr) / invu[ix + 1 + i][iy][iz]);
          }
        ...
        } else // Corner interface
        {
          ...
          left_suml += inter_node_left.wei.weil[0][n] *
                       eq.Jump_u(left_x, left_y, left_z);
          left_suml += inter_node_left.wei.weil[0][n + 1] *
                       eq.Jump_betau_x(left_x, left_y, left_z);
          left_suml += inter_node_left.wei.weil[0][n + 2] *
                       eq.Jump_u(right_x, right_y, right_z);
          left_suml += inter_node_left.wei.weil[0][n + 3] *
                       eq.Jump_betau_x(right_x, right_y, right_z);
          ...
          for (int i = 0; i < n; i++) {
            ...
            right_sumr +=
                inter_node_right.wei.weir[0][i] * u[ix - 1 + i][iy][iz];
          }

          // Left corner interface
          ifpx[iy][iz][ip].err.errl[0] =
              abs((invu[ix][iy][iz] - left_suml) / invu[ix][iy][iz]);
          ifpx[iy][iz][ip].err.errr[0] =
              abs((invu[ix + 1][iy][iz] - left_sumr) / invu[ix + 1][iy][iz]);

          // Right corner interface
          ifpx[iy][iz][ip + 1].err.errl[0] = ifpx[iy][iz][ip].err.errr[0];
          ifpx[iy][iz][ip + 1].err.errr[0] =
              abs((invu[ix + 2][iy][iz] - right_sumr) / invu[ix + 2][iy][iz]);
...
void Intersections::Refresh_Jump(Equation &eq, CubicDoub &uh, Beta &beta) {
  ...
  for (int ix = 1; ix < nx - 1; ix++) {
    for (int iy = 1; iy < ny - 1; iy++) {
      for (size_t ip = 0; ip < ifpz[ix][iy].size(); ip++) {
        ...
        ifpz[ix][iy][ip].jump.betau_xi = eq.Jump_betau_xi(
            coord_x, coord_y, coord_z, ifpz[ix][iy][ip].p[0][0],
            ifpz[ix][iy][ip].p[0][1], ifpz[ix][iy][ip].p[0][2]);
        ifpz[ix][iy][ip].jump.u_eta =
            eq.Jump_u_eta(coord_x, coord_y, coord_z, ifpz[ix][iy][ip].p[1][0],
                          ifpz[ix][iy][ip].p[1][1], ifpz[ix][iy][ip].p[1][2]);
        ifpz[ix][iy][ip].jump.u_tau =
            eq.Jump_u_tau(coord_x, coord_y, coord_z, ifpz[ix][iy][ip].p[2][0],
                          ifpz[ix][iy][ip].p[2][1], ifpz[ix][iy][ip].p[2][2]);
        ...
        eta = p[1][0] * eq.Jump_betau_x(coord_x, coord_y, coord_z) +
              p[1][1] * eq.Jump_betau_y(coord_x, coord_y, coord_z) +
              p[1][2] * eq.Jump_betau_z(coord_x, coord_y, coord_z);
        ifpz[ix][iy][ip].jump.eta_err = abs(jumpbeta_eta - eta) / eta;
        tau = p[2][0] * eq.Jump_betau_x(coord_x, coord_y, coord_z) +
              p[2][1] * eq.Jump_betau_y(coord_x, coord_y, coord_z) +
              p[2][2] * eq.Jump_betau_z(coord_x, coord_y, coord_z);
        ...
        // ************************* Change to MIB here
        // *****************************
        // ifpz[ix][iy][ip].jump.u_dir = p[2][0] * jumpbeta_xi + p[2][1] *
        // jumpbeta_eta + p[2][2] * jumpbeta_tau;

        ifpz[ix][iy][ip].jump.err =
            abs(ifpz[ix][iy][ip].jump.u_dir -
                eq.Jump_betau_z(coord_x, coord_y, coord_z)) /
            eq.Jump_betau_z(coord_x, coord_y, coord_z);
      }
    }
  }
  ...
  for (int ix = 1; ix < nx - 1; ix++) {
    for (int iz = 1; iz < nz - 1; iz++) {
      for (size_t ip = 0; ip < ifpy[ix][iz].size(); ip++) {
        ...
        ifpy[ix][iz][ip].jump.betau_xi = eq.Jump_betau_xi(
            coord_x, coord_y, coord_z, ifpy[ix][iz][ip].p[0][0],
            ifpy[ix][iz][ip].p[0][1], ifpy[ix][iz][ip].p[0][2]);
        ifpy[ix][iz][ip].jump.u_eta =
            eq.Jump_u_eta(coord_x, coord_y, coord_z, ifpy[ix][iz][ip].p[1][0],
                          ifpy[ix][iz][ip].p[1][1], ifpy[ix][iz][ip].p[1][2]);
        ifpy[ix][iz][ip].jump.u_tau =
            eq.Jump_u_tau(coord_x, coord_y, coord_z, ifpy[ix][iz][ip].p[2][0],
                          ifpy[ix][iz][ip].p[2][1], ifpy[ix][iz][ip].p[2][2]);
        ...
        // ************************* Change to MIB here
        // *****************************
        // ifpy[ix][iz][ip].jump.u_dir = p[1][0] * jumpbeta_xi + p[1][1] *
        // jumpbeta_eta + p[1][2] * jumpbeta_tau;

        ifpy[ix][iz][ip].jump.err =
            abs(ifpy[ix][iz][ip].jump.u_dir -
                eq.Jump_betau_y(coord_x, coord_y, coord_z)) /
            eq.Jump_betau_y(coord_x, coord_y, coord_z);
      }
    }
  }
  ...
  for (int iy = 1; iy < ny - 1; iy++) {
    for (int iz = 1; iz < nz - 1; iz++) {
      for (size_t ip = 0; ip < ifpx[iy][iz].size(); ip++) {
        ...
        ifpx[iy][iz][ip].jump.betau_xi = eq.Jump_betau_xi(
            coord_x, coord_y, coord_z, ifpx[iy][iz][ip].p[0][0],
            ifpx[iy][iz][ip].p[0][1], ifpx[iy][iz][ip].p[0][2]);
        ifpx[iy][iz][ip].jump.u_eta =
            eq.Jump_u_eta(coord_x, coord_y, coord_z, ifpx[iy][iz][ip].p[1][0],
                          ifpx[iy][iz][ip].p[1][1], ifpx[iy][iz][ip].p[1][2]);
        ifpx[iy][iz][ip].jump.u_tau =
            eq.Jump_u_tau(coord_x, coord_y, coord_z, ifpx[iy][iz][ip].p[2][0],
                          ifpx[iy][iz][ip].p[2][1], ifpx[iy][iz][ip].p[2][2]);
        ...
        // ************************* Change to MIB here
        // *****************************
        // ifpx[iy][iz][ip].jump.u_dir = p[0][0] * jumpbeta_xi + p[0][1] *
        // jumpbeta_eta + p[0][2] * jumpbeta_tau;

        ifpx[iy][iz][ip].jump.err =
            abs(ifpx[iy][iz][ip].jump.u_dir -
                eq.Jump_betau_x(coord_x, coord_y, coord_z)) /
            eq.Jump_betau_x(coord_x, coord_y, coord_z);
      }
    }
  }
...
/************************************************************************************************************************
 Normalized local coordinate transformation matrix initialization at given
 intersection node on yz plane in x-direction
...
/************************************************************************************************************************
 Normalized local coordinate transformation matrix initialization at given
 intersection node on xz plane in y-direction
...
/************************************************************************************************************************
 Normalized local coordinate transformation matrix initialization at given
 intersection node on xy plane in z-direction
 ...
 ******************************************************************************************************************/
void Intersections::Search_indx(Char_I axis, Int_I ix, Int_I iy, Int_I iz,
                                VecInt_O &outside, VecInt_O &inside) {
  VecInt indx;
  int temp, dis_out, dis_in;

  indx.resize(3);

  // Initialize all indices of outside approximation on-grid nodes and inside
  // approximation on-grid nodes with -1
  for (int i = 0; i < 3; i++) {
    outside[i] = -1;
    inside[i] = -1;
  }
  ...
  if (axis == 'x') {
    ...
    for (int i = 0; i < nx - 2; i++) {
      ...
      if (indicator[indx[0]] > 0 && indicator[indx[1]] > 0 &&
          indicator[indx[2]] > 0) {
        // relative distance
...
/******************************************************************************************************************
 Initialize informations of auxiliary nodes on the Plane Y=IY with intersecting
 line of Y=IY Plane and Tangent Plane

 INPUT
 inter_node : given intersection node

 OUTPUT
 inter_node.auxlaxis       : the axis used for approximate auxiliary points
...
void Intersections::Auxiliary_eta_x(Intersection_Data &inter_node) {
  ...
  double z_upper_auxl, z_lower_auxl;
  ...
  /*
   //Z coordinate of auxilary points on upper line X=x_upper and lower line
   X=x_lower
  ...
  if ((inter_node.eta.auxl[0] < xi[0]) ||
      (inter_node.eta.auxl[0] > xi[nx - 1]) ||
      (inter_node.eta.auxl[1] < xi[0]) ||
      (inter_node.eta.auxl[1] > xi[nx - 1])) {
    cout << "Auxilary nodes in eta direction are out of boundary on x "
            "direction of Plane Y"
         << endl;
    exit(0);
  }
  ...
  for (int i = 0; i < nx; i++) {
    if ((xi[i] < inter_node.eta.auxl[0]) &&
        (inter_node.eta.auxl[0] < xi[i + 1])) {
      upper = i;
    }
    if ((xi[i] < inter_node.eta.auxl[1]) &&
        (inter_node.eta.auxl[1] < xi[i + 1])) {
      lower = i;
    }
  }
  ...
  /*
   ...
   //Check if the auxilary points are in domain
   if((inter_node.eta.auxl[0]<zi[0]) || (inter_node.eta.auxl[0]>zi[nz-1]) ||
   (inter_node.eta.auxl[1]<zi[0]) || (inter_node.eta.auxl[1]>zi[nz-1]))
   {
   cout << "Auxilary nodes in eta direction are out of boundary on z direction
   of Plane Y"<< endl;
   exit(0);
   }
  ...
  // Case 4, both inside and outside domain available
    ...
    if (inter_node.eta.auxlaxis[0] == 'z') {
      for (int i = 0; i < 3; i++) {
        outside_distance += abs(xi[upper_outside[i]] - inter_node.eta.auxl[0]) +
                            abs(xi[lower_outside[i]] - inter_node.eta.auxl[1]);
        inside_distance += abs(xi[upper_inside[i]] - inter_node.eta.auxl[0]) +
                           abs(xi[lower_inside[i]] - inter_node.eta.auxl[1]);
      }
    } else if (inter_node.eta.auxlaxis[0] == 'x') {
      for (int i = 0; i < 3; i++) {
        outside_distance += abs(zi[upper_outside[i]] - inter_node.eta.auxl[0]) +
                            abs(zi[lower_outside[i]] - inter_node.eta.auxl[1]);
        inside_distance += abs(zi[upper_inside[i]] - inter_node.eta.auxl[0]) +
...
void Intersections::Auxiliary_tau_x(Intersection_Data &inter_node) {
  ...
  // Check if the auxilary points are in domain
  if ((inter_node.tau.auxl[0] < xi[0]) ||
      (inter_node.tau.auxl[0] > xi[nx - 1]) ||
      (inter_node.tau.auxl[1] < xi[0]) ||
      (inter_node.tau.auxl[1] > xi[nx - 1])) {
    cout << "Auxilary nodes in tau direction are out of boundary on x "
            "direction of Plane Z"
         << endl;
    exit(0);
  }
  ...
  for (int i = 0; i < nx; i++) {
    if ((xi[i] < inter_node.tau.auxl[0]) &&
        (inter_node.tau.auxl[0] < xi[i + 1])) {
      ix_upper = i;
    }
    if ((xi[i] < inter_node.tau.auxl[1]) &&
        (inter_node.tau.auxl[1] < xi[i + 1])) {
      ix_lower = i;
    }
  }
  ...
  // Case 4, both inside and outside domain available
    ...
    // Compare which six nodes is closer to two auxiliary points
    for (int i = 0; i < 3; i++) {
      outside_distance += abs(xi[upper_outside[i]] - inter_node.tau.auxl[0]) +
                          abs(xi[lower_outside[i]] - inter_node.tau.auxl[1]);
      inside_distance += abs(xi[upper_inside[i]] - inter_node.tau.auxl[0]) +
...
/******************************************************************************************************************
 Initialize informations of auxiliary nodes on the Plane X=IX with intersecting
 line of X=IX Plane and Tangent Plane
...
void Intersections::Auxiliary_eta_y(Intersection_Data &inter_node) {
  ...
  // Check if the auxilary points are in domain
  if ((inter_node.eta.auxl[0] < yi[0]) ||
      (inter_node.eta.auxl[0] > yi[ny - 1]) ||
      (inter_node.eta.auxl[1] < yi[0]) ||
      (inter_node.eta.auxl[1] > yi[ny - 1])) {
    cout << "Auxilary nodes in eta direction are out of boundary on y "
            "direction of Plane X"
         << endl;
    exit(0);
  }
  ...
  // Find index of left node for upper and lower auxiliary points
  for (int i = 0; i < ny; i++) {
    if ((yi[i] < inter_node.eta.auxl[0]) &&
        (inter_node.eta.auxl[0] < yi[i + 1])) {
      iy_upper = i;
    }
    if ((yi[i] < inter_node.eta.auxl[1]) &&
        (inter_node.eta.auxl[1] < yi[i + 1])) {
      iy_lower = i;
    }
  }
  ...
  // Case 4, both inside and outside domain available
    ...
    // Compare which six nodes is closer to two auxiliary points
    for (int i = 0; i < 3; i++) {
      outside_distance += abs(yi[upper_outside[i]] - inter_node.eta.auxl[0]) +
                          abs(yi[lower_outside[i]] - inter_node.eta.auxl[1]);
      inside_distance += abs(yi[upper_inside[i]] - inter_node.eta.auxl[0]) +
...
void Intersections::Auxiliary_tau_y(Intersection_Data &inter_node) {
  ...
  // Check if the auxilary points are in domain
  if ((inter_node.tau.auxl[0] < yi[0]) ||
      (inter_node.tau.auxl[0] > yi[ny - 1]) ||
      (inter_node.tau.auxl[1] < yi[0]) ||
      (inter_node.tau.auxl[1] > yi[ny - 1])) {
    cout << "Auxilary nodes in tau direction are out of boundary on y "
            "direction of Plane Z"
         << endl;
    exit(0);
  }
  ...
  // Find index of left node for upper and lower auxiliary points
  for (int i = 0; i < ny; i++) {
    if ((yi[i] < inter_node.tau.auxl[0]) &&
        (inter_node.tau.auxl[0] < yi[i + 1])) {
      iy_upper = i;
    }
    if ((yi[i] < inter_node.tau.auxl[1]) &&
        (inter_node.tau.auxl[1] < yi[i + 1])) {
      iy_lower = i;
    }
  }
  ...
  // Case 4, both inside and outside domain available
    ...
    // Compare which six nodes is closer to two auxiliary points
    for (int i = 0; i < 3; i++) {
      outside_distance += abs(yi[upper_outside[i]] - inter_node.tau.auxl[0]) +
                          abs(yi[lower_outside[i]] - inter_node.tau.auxl[1]);
      inside_distance += abs(yi[upper_inside[i]] - inter_node.tau.auxl[0]) +
...
void Intersections::Auxiliary_eta_z(Intersection_Data &inter_node) {
  ...
  // Check if the auxilary points are in domain
  if ((inter_node.eta.auxl[0] < zi[0]) ||
      (inter_node.eta.auxl[0] > zi[nz - 1]) ||
      (inter_node.eta.auxl[1] < zi[0]) ||
      (inter_node.eta.auxl[1] > zi[nz - 1])) {
    cout << "Auxilary nodes in eta direction are out of boundary on z "
            "direction of Plane X"
         << endl;
    exit(0);
  }
  ...
  // Find index of left node for upper and lower auxiliary points
  for (int i = 0; i < nz; i++) {
    if ((zi[i] < inter_node.eta.auxl[0]) &&
        (inter_node.eta.auxl[0] < zi[i + 1])) {
      iz_upper = i;
    }
    if ((zi[i] < inter_node.eta.auxl[1]) &&
        (inter_node.eta.auxl[1] < zi[i + 1])) {
      iz_lower = i;
    }
  }
...
void Intersections::Auxiliary_tau_z(Intersection_Data &inter_node) {
  ...
  // Check if the auxilary points are in domain
  if ((inter_node.tau.auxl[0] < zi[0]) ||
      (inter_node.tau.auxl[0] > zi[nz - 1]) ||
      (inter_node.tau.auxl[1] < zi[0]) ||
      (inter_node.tau.auxl[1] > zi[nz - 1])) {
    cout << "Auxilary nodes in tau direction are out of boundary on z "
            "direction of Plane Y"
         << endl;
    exit(0);
  }
  ...
  // Find index of left node for upper and lower auxiliary points
  for (int i = 0; i < nz; i++) {
    if ((zi[i] < inter_node.tau.auxl[0]) &&
        (inter_node.tau.auxl[0] < zi[i + 1])) {
      iz_upper = i;
    }
    if ((zi[i] < inter_node.tau.auxl[1]) &&
        (inter_node.tau.auxl[1] < zi[i + 1])) {
      iz_lower = i;
    }
  }
  ...
  // Case 4, both inside and outside domain available
    ...
    // Compare which six nodes is closer to two auxiliary points
    for (int i = 0; i < 3; i++) {
      outside_distance += abs(zi[upper_outside[i]] - inter_node.tau.auxl[0]) +
                          abs(zi[lower_outside[i]] - inter_node.tau.auxl[1]);
      inside_distance += abs(zi[upper_inside[i]] - inter_node.tau.auxl[0]) +
...
/*******************************************************************************************
 Calculating of jump beta Eta for given intersection on x-direction based on
 current solution
...
double Intersections::Eta_x(Intersection_Data &inter_node, CubicDoub &uh,
  ...
  /*
   upper_distance =
   sqrt(abs(x_upper-x0)*abs(x_upper-x0)*inter_node.p[1][0]*inter_node.p[1][0]+
   dz*dz*inter_node.p[1][2]*inter_node.p[1][2]);
   lower_distance =
   sqrt(abs(x_lower-x0)*abs(x_lower-x0)*inter_node.p[1][0]*inter_node.p[1][0]+
   dz*dz*inter_node.p[1][2]*inter_node.p[1][2]);
   */
  ...
  if ((REG == 'o') || (inter_node.eta.region == 'o')) {
    ...
    for (int i = 0; i < 3; i++) {
      upper_value +=
          uh[inter_node.eta.uout_auxlnodes[i]][iy][iz + 1] * wei_upper[i][0];
      lower_value +=
          uh[inter_node.eta.lout_auxlnodes[i]][iy][iz - 1] * wei_lower[i][0];
    }
  ...
  // use all inside nodes for auxiliary points approximation
    ...
    for (int i = 0; i < 3; i++) {
      upper_value +=
          uh[inter_node.eta.uin_auxlnodes[i]][iy][iz + 1] * wei_upper[i][0];
      lower_value +=
          uh[inter_node.eta.lin_auxlnodes[i]][iy][iz - 1] * wei_lower[i][0];
    }
    ...
    cout << "Approximation region isn't found, should only be 'o' for outside "
            "or 'i' for inside"
         << endl;
    exit(0);
  }
...
/*******************************************************************************************
 Calculating of jump beta Tau for given intersection on x-direction based on
 current solution
...
double Intersections::Tau_x(Intersection_Data &inter_node, CubicDoub &uh,
  ...
  /*
   upper_distance =
   sqrt(abs(x_upper-x0)*abs(x_upper-x0)*inter_node.p[2][0]*inter_node.p[2][0]+
   dy*dy*inter_node.p[2][1]*inter_node.p[2][1]);
   lower_distance =
   sqrt(abs(x_lower-x0)*abs(x_lower-x0)*inter_node.p[2][0]*inter_node.p[2][0]+
   dy*dy*inter_node.p[2][1]*inter_node.p[2][1]);
   */
  ...
  if ((REG == 'o') || (inter_node.tau.region == 'o')) {
    ...
    for (int i = 0; i < 3; i++) {
      upper_value +=
          uh[inter_node.tau.uout_auxlnodes[i]][iy + 1][iz] * wei_upper[i][0];
      lower_value +=
          uh[inter_node.tau.lout_auxlnodes[i]][iy - 1][iz] * wei_lower[i][0];
    }
    ...
    for (int i = 0; i < 3; i++) {
      upper_value +=
          uh[inter_node.tau.uin_auxlnodes[i]][iy + 1][iz] * wei_upper[i][0];
      lower_value +=
          uh[inter_node.tau.lin_auxlnodes[i]][iy - 1][iz] * wei_lower[i][0];
    }
...
/*******************************************************************************************
 Calculating of jump beta Eta for given intersection on y-direction based on
 current solution
...
double Intersections::Eta_y(Intersection_Data &inter_node, CubicDoub &uh,
  ...
  /*
   upper_distance =
   sqrt(abs(y_upper-y0)*abs(y_upper-y0)*inter_node.p[1][1]*inter_node.p[1][1]+
   dz*dz*inter_node.p[1][2]*inter_node.p[1][2]);
   lower_distance =
   sqrt(abs(y_lower-y0)*abs(y_lower-y0)*inter_node.p[1][1]*inter_node.p[1][1]+
   dz*dz*inter_node.p[1][2]*inter_node.p[1][2]);
   */
  ...
  if ((REG == 'o') || (inter_node.eta.region == 'o')) {
    ...
    for (int i = 0; i < 3; i++) {
      upper_value +=
          uh[ix][inter_node.eta.uout_auxlnodes[i]][iz + 1] * wei_upper[i][0];
      lower_value +=
          uh[ix][inter_node.eta.lout_auxlnodes[i]][iz - 1] * wei_lower[i][0];
    }
    ...
    for (int i = 0; i < 3; i++) {
      upper_value +=
          uh[ix][inter_node.eta.uin_auxlnodes[i]][iz + 1] * wei_upper[i][0];
      lower_value +=
          uh[ix][inter_node.eta.lin_auxlnodes[i]][iz - 1] * wei_lower[i][0];
    }
...
/*******************************************************************************************
 Calculating of jump beta Tau for given intersection on y-direction based on
 current solution
...
double Intersections::Tau_y(Intersection_Data &inter_node, CubicDoub &uh,
  ...
  /*
   upper_distance =
   sqrt(abs(y_upper-y0)*abs(y_upper-y0)*inter_node.p[2][1]*inter_node.p[2][1]+
   dx*dx*inter_node.p[2][0]*inter_node.p[2][0]);
   lower_distance =
   sqrt(abs(y_lower-y0)*abs(y_lower-y0)*inter_node.p[2][1]*inter_node.p[2][1]+
   dx*dx*inter_node.p[2][0]*inter_node.p[2][0]);
   */
  ...
  if ((REG == 'o') || (inter_node.tau.region == 'o')) {
    ...
    for (int i = 0; i < 3; i++) {
      upper_value +=
          uh[ix + 1][inter_node.tau.uout_auxlnodes[i]][iz] * wei_upper[i][0];
      lower_value +=
          uh[ix - 1][inter_node.tau.lout_auxlnodes[i]][iz] * wei_lower[i][0];
    }
    ...
    for (int i = 0; i < 3; i++) {
      upper_value +=
          uh[ix + 1][inter_node.tau.uin_auxlnodes[i]][iz] * wei_upper[i][0];
      lower_value +=
          uh[ix - 1][inter_node.tau.lin_auxlnodes[i]][iz] * wei_lower[i][0];
    }
...
/*******************************************************************************************
 Calculating of jump beta Eta for given intersection on z-direction based on
 current solution
...
double Intersections::Eta_z(Intersection_Data &inter_node, CubicDoub &uh,
  ...
  /*
   upper_distance =
   sqrt(abs(z_upper-z0)*abs(z_upper-z0)*inter_node.p[1][2]*inter_node.p[1][2]+
   dy*dy*inter_node.p[1][1]*inter_node.p[1][1]);
   lower_distance =
   sqrt(abs(z_lower-z0)*abs(z_lower-z0)*inter_node.p[1][2]*inter_node.p[1][2]+
   dy*dy*inter_node.p[1][1]*inter_node.p[1][1]);
   */
  ...
  if ((REG == 'o') || (inter_node.eta.region == 'o')) {
    ...
    for (int i = 0; i < 3; i++) {
      upper_value +=
          uh[ix][iy + 1][inter_node.eta.uout_auxlnodes[i]] * wei_upper[i][0];
      lower_value +=
          uh[ix][iy - 1][inter_node.eta.lout_auxlnodes[i]] * wei_lower[i][0];
    }
    ...
    for (int i = 0; i < 3; i++) {
      upper_value +=
          uh[ix][iy + 1][inter_node.eta.uin_auxlnodes[i]] * wei_upper[i][0];
      lower_value +=
          uh[ix][iy - 1][inter_node.eta.lin_auxlnodes[i]] * wei_lower[i][0];
    }
...
/*******************************************************************************************
 Calculating of jump beta Tau for given intersection on z-direction based on
 current solution
...
double Intersections::Tau_z(Intersection_Data &inter_node, CubicDoub &uh,
  ...
  /*
   upper_distance =
   sqrt(abs(z_upper-z0)*abs(z_upper-z0)*inter_node.p[2][2]*inter_node.p[2][2]+
   dx*dx*inter_node.p[2][0]*inter_node.p[2][0]);
   lower_distance =
   sqrt(abs(z_lower-z0)*abs(z_lower-z0)*inter_node.p[2][2]*inter_node.p[2][2]+
   dx*dx*inter_node.p[2][0]*inter_node.p[2][0]);
   */
  ...
  if ((REG == 'o') || (inter_node.tau.region == 'o')) {
    ...
    for (int i = 0; i < 3; i++) {
      upper_value +=
          uh[ix + 1][iy][inter_node.tau.uout_auxlnodes[i]] * wei_upper[i][0];
      lower_value +=
          uh[ix - 1][iy][inter_node.tau.lout_auxlnodes[i]] * wei_lower[i][0];
    }
    ...
    for (int i = 0; i < 3; i++) {
      upper_value +=
          uh[ix + 1][iy][inter_node.tau.uin_auxlnodes[i]] * wei_upper[i][0];
      lower_value +=
          uh[ix - 1][iy][inter_node.tau.lin_auxlnodes[i]] * wei_lower[i][0];
    }
 ...
 *****************************************************************/
double Intersections::Eta_Plus(Intersection_Data &inter_node, Beta &beta,
                               Doub_I eta_plus) {
  double temp;
...
/*****************************************************************
 ...
 eta_plus : jump beta eta^{-}
 *****************************************************************/
double Intersections::Eta_Minus(Intersection_Data &inter_node, Beta &beta,
                                Doub_I eta_minus) {
  double temp;
 ...
 *****************************************************************/
double Intersections::Tau_Plus(Intersection_Data &inter_node, Beta &beta,
                               Doub_I tau_plus) {
  double temp;
...
/*****************************************************************
 ...
 tau_plus : jump beta tau^{-}
 *****************************************************************/
double Intersections::Tau_Minus(Intersection_Data &inter_node, Beta &beta,
                                Doub_I tau_minus) {
  double temp;
...
void Intersections::Check_size_xy() {
  ...
  for (size_t ix = 0; ix < ifpz.size(); ix++) {
    for (size_t iy = 0; iy < ifpz[ix].size(); iy++) {
      cout << "ix: " << ix << " iy: " << iy << " inode: " << ifpz[ix][iy].size()
           << endl;
    }
  }
}
...
void Intersections::Check_size_xz() {
  ...
  for (size_t ix = 0; ix < ifpy.size(); ix++) {
    for (size_t iz = 0; iz < ifpy[ix].size(); iz++) {
      cout << "ix: " << ix << " iz: " << iz << " inode: " << ifpy[ix][iz].size()
           << endl;
    }
  }
}
...
void Intersections::Check_size_yz() {
  ...
  for (size_t iy = 0; iy < ifpx.size(); iy++) {
    for (size_t iz = 0; iz < ifpx[iy].size(); iz++) {
      cout << "iy: " << iy << " iz: " << iz << " inode: " << ifpx[iy][iz].size()
           << endl;
    }
  }
}
...
void Intersections::Check_coord(Surface_Cartesian &ex) {
  ...
  for (int ix = 1; ix < nx - 1; ix++) {
    for (int iy = 1; iy < ny - 1; iy++) {
      for (size_t ip = 0; ip < ifpz[ix][iy].size(); ip++) {
        temp = ex.check(ifpz[ix][iy][ip].coord.x_value,
                        ifpz[ix][iy][ip].coord.y_value,
                        ifpz[ix][iy][ip].coord.z_value);
        cout << temp << endl;
      }
    }
  }
  ...
  for (int ix = 1; ix < nx - 1; ix++) {
    for (int iz = 1; iz < nz - 1; iz++) {
      for (size_t ip = 0; ip < ifpy[ix][iz].size(); ip++) {
        temp = ex.check(ifpy[ix][iz][ip].coord.x_value,
                        ifpy[ix][iz][ip].coord.y_value,
                        ifpy[ix][iz][ip].coord.z_value);
        cout << temp << endl;
      }
    }
  }
  ...
  for (int iy = 1; iy < ny - 1; iy++) {
    for (int iz = 1; iz < nz - 1; iz++) {
      for (size_t ip = 0; ip < ifpx[iy][iz].size(); ip++) {
        temp = ex.check(ifpx[iy][iz][ip].coord.x_value,
                        ifpx[iy][iz][ip].coord.y_value,
                        ifpx[iy][iz][ip].coord.z_value);
        cout << temp << endl;
      }
    }
  }
...
/************************************************************************
 ...
 inter_node : given intersection node
 ************************************************************************/
void Intersections::Intersection_display(Intersection_Data inter_node,
                                         int ind) {
  if (inter_node.ID < 0) {
  ...
  /*
   ...
   cout << "X-value: " << inter_node.coord.x_value << " Y-value: " <<
   inter_node.coord.y_value
   << " Z-value: " << inter_node.coord.z_value << endl;

   if(inter_node.dir == 'x')
   {
   cout << "Y-direction: " << inter_node.line.indx1 << " Z-direction: " <<
   inter_node.line.indx2 << endl;
   }
   else if(inter_node.dir == 'y')
   {
   cout << "X-direction: " << inter_node.line.indx1 << " Z-direction: " <<
   inter_node.line.indx2 << endl;
   }
   else if(inter_node.dir == 'z')
   {
   cout << "X-direction: " << inter_node.line.indx1 << " Y-direction: " <<
   inter_node.line.indx2 << endl;
   }
   else
   {
   ...
   //cout << "zenith: " << inter_node.angle.zenith << " azimuth: " <<
   inter_node.angle.azimuth << endl;
  ...
  for (size_t i = 0; i < inter_node.err.errr.size(); i++) {
    cout << i << ": " << inter_node.err.errl[i] << endl;
  }
  cout << "Error right: " << endl;
  for (size_t i = 0; i < inter_node.err.errl.size(); i++) {
 ...
 ******************************************************************************/
void Intersections::Weights(Doub_I z, VecDoub_I &x, Int_I n, Int_I m,
                            MatrixDoub_O &c) {
