 ...
 ***********************************************************************/
double Surface_Heart::Set_Node(const Doub_I x, const Doub_I y,
                               const Doub_I z) const {
  double diff;

  diff = pow((par[0] * x * x + par[1] * y * y + par[2] * z * z + par[3]), 3) +
         par[4] * x * x * z * z * z + par[5] * y * y * z * z * z + TOL_SETUP;
...
/*********************************************************************************
 ...
 value of function
 **********************************************************************************/
double Surface_Heart::func(const Doub_I x, const Doub_I y,
                           const Doub_I z) const {
  double temp;

  temp = pow((par[0] * x * x + par[1] * y * y + par[2] * z * z + par[3]), 3) +
         par[4] * x * x * z * z * z + par[5] * y * y * z * z * z;
 ...
 ***********************************************************************/
double Surface_Heart::dfx(const Doub_I x, const Doub_I y,
                          const Doub_I z) const {
  double temp;

  temp =
      par[0] * 6 * x *
          pow((par[0] * x * x + par[1] * y * y + par[2] * z * z + par[3]), 2) +
      par[4] * 2 * x * z * z * z;
 ...
 ***********************************************************************/
double Surface_Heart::dfy(const Doub_I x, const Doub_I y,
                          const Doub_I z) const {
  double temp;
 ...
 ***********************************************************************/
double Surface_Heart::dfz(const Doub_I x, const Doub_I y,
                          const Doub_I z) const {
  double temp;
  ...
  temp =
      par[2] * 6 * z *
          pow((par[0] * x * x + par[1] * y * y + par[2] * z * z + par[3]), 2) +
      par[4] * 3 * x * x * z * z + par[5] * 3 * y * y * z * z;
...
VecDoub Surface_Heart::normal(Doub_I x, Doub_I y, Doub_I z) {
  ...
  total = sqrt(pow(par[0] * 6 * x * pow((par[0] * x * x + par[1] * y * y +
                                         par[2] * z * z + par[3]),
                                        2) +
                       par[4] * 2 * x * z * z * z,
                   2) +
               pow(6 * par[1] * y * pow((par[0] * x * x + par[1] * y * y +
                                         par[2] * z * z + par[3]),
                                        2) +
                       2 * par[5] * y * z * z * z,
                   2) +
               pow(par[2] * 6 * z * pow((par[0] * x * x + par[1] * y * y +
                                         par[2] * z * z + par[3]),
                                        2) +
                       par[4] * 3 * x * x * z * z + par[5] * 3 * y * y * z * z,
                   2));
...
void Surface_Heart::display() {
  ...
  cout << "f(x) = [(" << par[0] << ")*x^2+(" << par[1] << ")*y^2+(" << par[2]
       << ")*z^2+(" << par[3] << ")]^3+(";
