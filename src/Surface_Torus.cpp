...
/*********************************************************************************
 ...
 value of function
 **********************************************************************************/
double Surface_Torus::func(const Doub_I x, const Doub_I y, const Doub_I z) const
{
    double temp;
 ...
 ***********************************************************************/
double Surface_Torus::dfx(const Doub_I x, const Doub_I y, const Doub_I z) const
{
    double temp;
 ...
 ***********************************************************************/
double Surface_Torus::dfy(const Doub_I x, const Doub_I y, const Doub_I z) const
{
    double temp;
 ...
 ***********************************************************************/
double Surface_Torus::dfz(const Doub_I x, const Doub_I y, const Doub_I z) const
{
    double temp;
...
void Surface_Torus::display()
{
    ...
    cout << "f(x) = [" << a << "-(x^y+y^2)^(1/2)]^2+z^2-" << b*b << " = 0" << endl;
}
