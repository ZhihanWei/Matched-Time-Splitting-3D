 ...
 ******************************************************************/
Eq_6::Eq_6(Doub_I ti, Beta& in_beta) : beta(in_beta) { t = ti; }
 ...
 *****************************************************/
double Eq_6::Inner_u(Doub_I x, Doub_I y, Doub_I z) const {
  double temp;
...
/****************************************************
 ...
 value of analytical solution at given node
 *****************************************************/
double Eq_6::Outer_u(Doub_I x, Doub_I y, Doub_I z) const {
  double temp;
 ...
 *****************************************************/
double Eq_6::Inner_f(Doub_I x, Doub_I y, Doub_I z) const {
  double temp;

  temp = -beta.Inside(x, y, z) * 10 * (-6 + 4 * (x * x + y * y + z * z)) *
             exp(-x * x) * exp(-y * y) * exp(-z * z) -
         exp(a + t) - beta.Inside_Dx(x, y, z) * Inner_dux(x, y, z) -
...
/****************************************************
 ...
 value of source term at given node
 *****************************************************/
double Eq_6::Outer_f(Doub_I x, Doub_I y, Doub_I z) const {
  double temp;

  temp = -beta.Outside(x, y, z) * 5 * (-6 + 4 * (x * x + y * y + z * z)) *
             exp(-x * x) * exp(-y * y) * exp(-z * z) +
         exp(a + t) - beta.Outside_Dx(x, y, z) * Outer_dux(x, y, z) -
 ...
 ***********************************************************************/
double Eq_6::Inner_dux(Doub_I x, Doub_I y, Doub_I z) const {
  double temp;
...
/**********************************************************************
 ...
 value of 1st derivative in x-direction at given node
 ***********************************************************************/
double Eq_6::Outer_dux(Doub_I x, Doub_I y, Doub_I z) const {
  double temp;
 ...
 ***********************************************************************/
double Eq_6::Inner_duy(Doub_I x, Doub_I y, Doub_I z) const {
  double temp;
...
/**********************************************************************
 ...
 value of 1st derivative in y-direction at given node
 ***********************************************************************/
double Eq_6::Outer_duy(Doub_I x, Doub_I y, Doub_I z) const {
  double temp;
 ...
 ***********************************************************************/
double Eq_6::Inner_duz(Doub_I x, Doub_I y, Doub_I z) const {
  double temp;
...
/**********************************************************************
 ...
 value of 1st derivative in z-direction at given node
 ***********************************************************************/
double Eq_6::Outer_duz(Doub_I x, Doub_I y, Doub_I z) const {
  double temp;
 ...
 ***************************************************************/
double Eq_6::Jump_betau_x(Doub_I x, Doub_I y, Doub_I z) const {
  double temp;
 ...
 ***************************************************************/
double Eq_6::Jump_betau_y(Doub_I x, Doub_I y, Doub_I z) const {
  double temp;
 ...
 ***************************************************************/
double Eq_6::Jump_betau_z(Doub_I x, Doub_I y, Doub_I z) const {
  double temp;
