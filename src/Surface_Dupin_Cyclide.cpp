...
/*********************************************************************************
 ...
 value of function
 **********************************************************************************/
double Surface_Dupin_Cyclide::func(const Doub_I x, const Doub_I y, const Doub_I z) const
{
    double temp;
 ...
 ***********************************************************************/
double Surface_Dupin_Cyclide::dfx(const Doub_I x, const Doub_I y, const Doub_I z) const
{
    double temp;
 ...
 ***********************************************************************/
double Surface_Dupin_Cyclide::dfy(const Doub_I x, const Doub_I y, const Doub_I z) const
{
    double temp;
 ...
 ***********************************************************************/
double Surface_Dupin_Cyclide::dfz(const Doub_I x, const Doub_I y, const Doub_I z) const
{
    double temp;
...
void Surface_Dupin_Cyclide::display()
{
    ...
    cout << "f(x) = [" << a << "-(x^y+y^2)^(1/2)]^2+z^2+" << b << "*x-" << c*c << " = 0" << endl;
}
