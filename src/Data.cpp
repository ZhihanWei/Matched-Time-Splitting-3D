...
Data::Prt_name Data::Translation(const string& in_string)
{
    ...
    else if(in_string == "zl") return e_zl;
    else if(in_string == "zr") return e_zr;
    else if(in_string == "t_start") return e_t_start;
    else if(in_string == "t_finish") return e_t_finish;
    else if(in_string == "t_step") return e_t_step;
    else if(in_string == "nx") return e_nx;
