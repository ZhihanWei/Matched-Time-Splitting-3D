 ...
 ***********************************************************************/
double Surface_Tanglecube::Set_Node(const Doub_I x, const Doub_I y,
                                    const Doub_I z) const {
  double diff;

  diff = par[0] * pow(x, 4) + par[1] * pow(x, 2) + par[2] * pow(y, 4) +
         par[3] * pow(y, 2) + par[4] * pow(z, 4) + par[5] * pow(z, 2) + par[6] +
         TOL_SETUP;
...
/*********************************************************************************
 ...
 value of function
 **********************************************************************************/
double Surface_Tanglecube::func(const Doub_I x, const Doub_I y,
                                const Doub_I z) const {
  double temp;

  temp = par[0] * pow(x, 4) + par[1] * pow(x, 2) + par[2] * pow(y, 4) +
         par[3] * pow(y, 2) + par[4] * pow(z, 4) + par[5] * pow(z, 2) + par[6];
 ...
 ***********************************************************************/
double Surface_Tanglecube::dfx(const Doub_I x, const Doub_I y,
                               const Doub_I z) const {
  double temp;
 ...
 ***********************************************************************/
double Surface_Tanglecube::dfy(const Doub_I x, const Doub_I y,
                               const Doub_I z) const {
  double temp;
 ...
 ***********************************************************************/
double Surface_Tanglecube::dfz(const Doub_I x, const Doub_I y,
                               const Doub_I z) const {
  double temp;
...
VecDoub Surface_Tanglecube::normal(Doub_I x, Doub_I y, Doub_I z) {
  ...
  total = sqrt(pow(4 * par[0] * pow(x, 3) + 2 * par[1] * x, 2) +
               pow(4 * par[2] * pow(y, 3) + 2 * par[3] * y, 2) +
               pow(4 * par[4] * pow(z, 3) + 2 * par[5] * z, 2));
...
void Surface_Tanglecube::display() {
  ...
  cout << "f(x) = (" << par[0] << ")*x^4+(" << par[1] << ")*x^2+(" << par[2]
       << ")*y^4+(" << par[3] << ")*y^2+(" << par[4] << ")*z^4+(" << par[5]
       << ")*z^2+(" << par[6] << ")=0" << endl;
}
