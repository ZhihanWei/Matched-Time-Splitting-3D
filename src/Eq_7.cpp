 ...
 ******************************************************************/
Eq_7::Eq_7(Doub_I ti, Beta& in_beta) : beta(in_beta) { t = ti; }
...
double Eq_7::Inner_f(Doub_I x, Doub_I y, Doub_I z) const {
  ...
  temp =
      3 * beta.Inside(x, y, z) * k * k * cos(k * x) * sin(k * y) * cos(k * z) +
      cos(t) - beta.Inside_Dx(x, y, z) * Inner_dux(x, y, z) -
...
double Eq_7::Outer_f(Doub_I x, Doub_I y, Doub_I z) const {
  ...
  temp =
      3 * beta.Outside(x, y, z) * k * k * sin(k * x) * cos(k * y) * sin(k * z) +
      cos(t) - beta.Outside_Dx(x, y, z) * Outer_dux(x, y, z) -
 ...
 ***************************************************************/
double Eq_7::Jump_betau_x(Doub_I x, Doub_I y, Doub_I z) const {
  double temp;
 ...
 ***************************************************************/
double Eq_7::Jump_betau_y(Doub_I x, Doub_I y, Doub_I z) const {
  double temp;
 ...
 ***************************************************************/
double Eq_7::Jump_betau_z(Doub_I x, Doub_I y, Doub_I z) const {
  double temp;
