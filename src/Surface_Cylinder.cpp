...
/*********************************************************************************
 ...
 value of function
 **********************************************************************************/
double Surface_Cylinder::func(const Doub_I x, const Doub_I y, const Doub_I z) const
{
    double temp;
 ...
 ***********************************************************************/
double Surface_Cylinder::dfx(const Doub_I x, const Doub_I y, const Doub_I z) const
{
    double temp;
 ...
 ***********************************************************************/
double Surface_Cylinder::dfy(const Doub_I x, const Doub_I y, const Doub_I z) const
{
    double temp;
...
void Surface_Cylinder::display()
{
    ...
    cout << "f(x) = x^2 + y^2 - " << r << "^2 = 0, where z in [" << z_lower << "," << z_upper << "]" << endl;
}
 ...
 *******************************************************************************/
double Surface_Cylinder::dfz(const Doub_I x, const Doub_I y, const Doub_I z) const
{
