 ...
 ******************************************************************/
Eq_0::Eq_0(Doub_I ti, Beta &in_beta) : beta(in_beta) { t = ti; }
...
double Eq_0::Inner_f(Doub_I x, Doub_I y, Doub_I z) const {
  ...
  temp = 0 - beta.Inside_Dx(x, y, z) * Inner_dux(x, y, z) -
...
double Eq_0::Outer_f(Doub_I x, Doub_I y, Doub_I z) const {
  ...
  temp = 0 - beta.Outside_Dx(x, y, z) * Outer_dux(x, y, z) -
...
double Eq_0::Jump_betau_x(Doub_I x, Doub_I y, Doub_I z) const {
  ...
  temp = beta.Inside(x, y, z) * Outer_dux(x, y, z) -
         beta.Outside(x, y, z) * Inner_dux(x, y, z);
